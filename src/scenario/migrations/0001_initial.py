    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_type', models.CharField(blank=True, choices=[('redevelopment', 'redevelopment project focused on additional new impervious area'), ('development', 'Green Field'), ('voluntary_redevelopment', 'BMP retrofit to existing development only (voluntary redevelopment)')], max_length=25, null=True, verbose_name='Project Type')),
                ...
                ('land_unit_cost', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('1'), default_currency='USD', max_digits=11, verbose_name='Cost per square foot of Project site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.CharField(choices=[('conventional', 'Gray Infrastructure'), ('nonconventional', 'Green Infrastructure')], default=None, max_length=15)),
                ('sort_nu', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='Sort Number')),
                ('units', models.CharField(default=None, max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_year', models.PositiveIntegerField(blank=True, default=20180, null=True, validators=[django.core.validators.MinValueValidator(2018), django.core.validators.MaxValueValidator(2090)])),
                ('replacement_life', models.PositiveIntegerField(blank=True, default=40, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name="Replacement Life ('R')")),
