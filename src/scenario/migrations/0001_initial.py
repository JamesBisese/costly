# Generated by Django 2.1.2 on 2019-07-16 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curb_and_gutter_checkbox', models.BooleanField(blank=True, default=False, null=True, verbose_name=' Checked')),
                ('curb_and_gutter_area', models.IntegerField(blank=True, default=0, null=True, verbose_name=' Area')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stormwater_wetland_first_year_costs_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('conversion_factor', models.CharField(blank=True, default=None, max_length=50, null=True, verbose_name='Conversion Factor')),
                ('factor_assumption_tx', models.CharField(blank=True, default=None, max_length=150, null=True, verbose_name='Factor Assumption')),
                ('sizing_factor_k', models.CharField(blank=True, default=None, max_length=10, null=True, verbose_name='Sizing Factor k')),
                ('sizing_factor_n', models.CharField(blank=True, default=None, max_length=10, null=True, verbose_name='Sizing Factor n')),
                ('construction_cost_factor_equation', models.CharField(blank=True, default=None, max_length=150, null=True, verbose_name='Construction Costs Factor Equation ')),
                ('costitem', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='scenario.CostItem')),
            ],
            options={
                'verbose_name_plural': 'Structure Cost Item Default Assumptions',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rsmeans_va_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('rsmeans_va', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=11, null=True, verbose_name='RSMeans unit cost')),
                ('db_25pct_va_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('db_25pct_va', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=11, null=True, verbose_name='DB 25-percentile unit cost')),
                ('db_50pct_va_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('db_50pct_va', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=11, null=True, verbose_name='DB Average unit cost')),
                ('db_75pct_va_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('db_75pct_va', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=11, null=True, verbose_name='DB 75-percentile unit cost')),
                ('replacement_life', models.PositiveIntegerField(blank=True, default=40, null=True, validators=[django.core.validators.MinValueValidator(5), django.core.validators.MaxValueValidator(100)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('factor_assumption_tx', models.CharField(blank=True, default=None, max_length=150, null=True, verbose_name='Factor Assumption')),
                ('sizing_factor_k', models.CharField(blank=True, default=None, max_length=10, null=True, verbose_name='Sizing Factor k')),
                ('sizing_factor_n', models.CharField(blank=True, default=None, max_length=10, null=True, verbose_name='Material Density - Sizing Factor n')),
                ('construction_cost_factor_equation', models.CharField(blank=True, default=None, max_length=150, null=True, verbose_name='Construction Costs Factor Equation ')),
                ('costitem', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='scenario.CostItem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_input_cost_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('user_input_cost', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=11, null=True, verbose_name='User supplied unit cost')),
                ...
                ('first_year_maintenance_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('first_year_maintenance', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=11, null=True, verbose_name='User supplied First Year Maintenance Cost')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_purchase_information', models.CharField(blank=True, choices=[('to_be_purchased', 'Needs to be purchased'), ('owned', 'Already owned')], default=None, max_length=15, null=True, verbose_name='Purchase Information')),
                ...
                ('project_area', models.CharField(blank=True, default=None, max_length=15, null=True, verbose_name='Total Project Area (square feet)')),
                ('land_unit_cost_currency', djmoney.models.fields.CurrencyField(choices=[('USD', 'US Dollar')], default='USD', editable=False, max_length=3)),
                ('land_unit_cost', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=11, null=True, verbose_name='Cost per ft2 of Project site')),
        ...
        migrations.AddField(
            model_name='costitemusercosts',
            name='scenario',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='cost_item_user_costs', to='scenario.Scenario'),
        ),
        migrations.AddField(
            model_name='costitemuserassumptions',
            name='scenario',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='cost_item_user_assumptions', to='scenario.Scenario'),
        ),
        migrations.AddField(
            model_name='costitemuserassumptions',
            name='structure',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='scenario.Structures'),
        ),
        migrations.AddField(
